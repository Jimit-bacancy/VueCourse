                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group">
                        ...
                        <input
                                type="text"
                                id="email"
                                class="form-control" v-model.trim="userData.email">
                    </div>
                    <div class="form-group">
                        ...
                        <input
                                type="password"
                                id="password"
                                class="form-control" v-model.trim="userData.password">
                    </div>
                    <div class="form-group">
                        ...
                        <input
                                type="number"
                                id="age"
                                class="form-control" v-model.trim="userData.age">
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 form-group">
                    ...
                    <textarea
                            id="message"
                            rows="5"
                            class="form-control" v-model.trim="userData.message"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
